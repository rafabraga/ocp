 ...
 *
 * ZonedDateTimes utilizam o ZoneRules na hora de fazer ajustes. Para criar uma datahora com timezone que não use o
 * ZoneRules, existe a OffsetDateTime.
 *
 * @author rafael
 *
 */
public class DatasHoras {
    ...
    public static void main(final String[] args) {
        ...
        // ZoneId.getAvailableZoneIds().stream().filter(z -> z.startsWith("America")).sorted().forEach(System.out::println);

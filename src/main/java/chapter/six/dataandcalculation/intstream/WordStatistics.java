package chapter.six.dataandcalculation.intstream;
...
public class WordStatistics {
	...
	public static void main(final String[] args) {
		final String limerick = "There was a young lady named Bright " + "who traveled much faster than light "
				+ "She set out one day " + "in a relative way " + "and came back the previous night ";

		final IntSummaryStatistics wordStatistics = Pattern.compile(" ").splitAsStream(limerick)
